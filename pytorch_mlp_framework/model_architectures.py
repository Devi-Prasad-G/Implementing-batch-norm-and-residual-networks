...
#Classes where Batch Normalization applied for processing blocks
...
class ConvolutionalProcessingBlockWithBN_RC(nn.Module):
    def __init__(self, input_shape, num_filters, kernel_size, padding, bias, dilation):
        super(ConvolutionalProcessingBlockWithBN_RC, self).__init__()
...
#class for batch normalization with residual connections.
